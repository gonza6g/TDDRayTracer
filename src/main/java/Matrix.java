public class Matrix {
    ...
    public Tuple multiply(Tuple tupleB) {
        if (data[0].length != 4) {
            throw new IllegalArgumentException("Matrix must have 4 columns for Tuple multiplication");
        }
    ...
    public double determinant() {
        if (data.length != data[0].length) {
            throw new IllegalArgumentException("Matrix should be a square matrix to calculate the determinant.");
        }
